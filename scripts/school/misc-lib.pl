...
sub Top
{
   ...
   $URL = &MyURL;
   return <<END_OF_TEXT;
<!--* This script and many others on this site have been
    * written by a member of Paramount Consulting, Inc.
    * and donated to the Tattered Cover for the purpose
    * of promoting children's literacy.
-->
<html>
<head>
<title>$input[0]</title>
</head>
<body bgcolor="$input[2]" text="$input[3]" link=ff0000 alink=990000
vlink=990000>
