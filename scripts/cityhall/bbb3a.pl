...
<img src = "$ktini{cityhallgraphics}/bbb3.gif">
...
<HR>
Do you want to<A HREF="$ktini{engine}?KEY=5170"> speak with an historian about the diary entry</A> or<A HREF="$ktini{engine}?KEY=5130"> continue questioning Willy?</A> 
