...
<img src = "$ktini{cityhallgraphics}/bbb5.gif">
...
<HR>
Do you want to<A HREF="$ktini{engine}?KEY=5110"> continue questioning Willy</A> or<A HREF="$ktini{engine}?KEY=5190"> examine the vault?</A> 
