...
<img src = "$ktini{cityhallgraphics}/bbb4.gif">
...
<TR><TD WIDTH = "100">
<IMG  SRC="$ktini{cityhallgraphics}/same.gif"></TD>
<TD WIDTH = "360"><FONT SIZE = "4">
<HR>
Do you want to <A HREF="$ktini{engine}?KEY=5080">look more closely at the
scrap of paper</A> or <A HREF="$ktini{engine}?KEY=5220">examine the vault?</A> 
